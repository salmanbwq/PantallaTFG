...
static void receiveRfScreen(void) {
    ...
    lv_obj_set_style_radius(dd_type, 10, 0);
    ...
    lv_obj_set_style_bg_color(returnBtn, lv_color_hex(0xD32F2F), 0);
    lv_obj_set_style_radius(returnBtn, 10, 0);
    lv_obj_set_style_shadow_width(returnBtn, 10, 0);
    lv_obj_set_style_shadow_color(returnBtn, lv_color_hex(0xAAAAAA), 0);
    lv_obj_set_style_bg_color(returnBtn, lv_color_hex(0xB71C1C), LV_STATE_PRESSED);
    lv_obj_t *returnBtnLabel = lv_label_create(returnBtn);
    lv_label_set_text(returnBtnLabel, "Return");
    lv_obj_set_style_text_color(returnBtnLabel, lv_color_hex(0xFFFFFF), 0);
