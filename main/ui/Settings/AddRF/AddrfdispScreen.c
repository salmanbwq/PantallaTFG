...
static void addrfdispScreen() {
    ...
    lv_obj_set_size(addRFInstance, 320, 240);
    ...
    lv_obj_align(dd_type, LV_ALIGN_TOP_LEFT, 20, 20);


    dd_freq = lv_dropdown_create(addRFInstance);
    lv_dropdown_set_options(dd_freq, "433 MHz\n868 MHz\n2.4 GHz");
    lv_obj_set_width(dd_freq, 140);
    lv_obj_align(dd_freq, LV_ALIGN_TOP_LEFT, 20, 80);
